/**
 * Test custom tools (function list to MCP converter) with Claude Agent SDK using Deno
 *
 * This test verifies that the createSdkMcpServer and tool helpers work correctly.
 */

import { query, tool, createSdkMcpServer } from "npm:@anthropic-ai/claude-agent-sdk";
import { z } from "npm:zod";

console.log("=== Testing Custom Tools with Deno ===\n");
