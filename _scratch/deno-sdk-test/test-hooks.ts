/**
 * Test hooks with Claude Agent SDK using Deno
 *
 * This tests the PreToolUse hook to intercept tool calls.
 */

import { query, HookCallback, PreToolUseHookInput } from "npm:@anthropic-ai/claude-agent-sdk";

console.log("=== Testing Hooks with Deno ===\n");
